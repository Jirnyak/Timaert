...
- **NPC ходят по океану бесплатно**: один закон стоимости местности
  ...
  чистой геометрией с плоским `rt.sp -= 10`.
...
Числа честного инструмента: 5330→5271 условий; main.cpp 1473→1421;
engine.cpp 446→443. Смоук-сюита: 16 сценариев PASS на новом мире (+ свип
console на seed 1,7; + валидированный прогон с Vulkan-валидацией).
