...
void test_peasants_pay_the_threat_price() {
    ...
    // тест ТЕРМ ОПАСНОСТИ, не экономику дефицита: закрытые полки глушат
    // покупной конец, оставляя страху скор прежнего масштаба. (Сырьё
    // пекарни закрывать не надо: производный спрос гасится полным амбаром
    // хлеба — неттинг складом выхода, economy.cpp.)
