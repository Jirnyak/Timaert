...
int main() {
    ...
    if (sm::spawn_npc_at(gs, w, sm::store_of(w), terrain, "grue", 10, 12, 3)) {
    ...
    if (!sm::spawn_npc_at(gs, w, sm::store_of(w), terrain, "Bandit", 10, 12, 3)) {
    ...
    if (!sm::spawn_npc_at(gs, w, sm::store_of(w), terrain, "bandit", 40, 40, 2)) {
