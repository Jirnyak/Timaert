...
public:
    ...
    [[nodiscard]] static constexpr std::size_t height() noexcept {
        return kHeight;
    }
    ...
    [[nodiscard]] TileType* data() noexcept {
        return tiles_.get();
    }
    [[nodiscard]] const TileType* data() const noexcept {
        return tiles_.get();
    }

    [[nodiscard]] TileType* begin() noexcept {
        return tiles_.get();
    }
    [[nodiscard]] const TileType* begin() const noexcept {
        return tiles_.get();
    }
    [[nodiscard]] TileType* end() noexcept {
        return tiles_.get() + kSize;
    }
    [[nodiscard]] const TileType* end() const noexcept {
        return tiles_.get() + kSize;
    }
