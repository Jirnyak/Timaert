...
WorldMap<LandmarkSystem::DistanceType>* LandmarkSystem::ensure_distance_field(std::size_t landmark_idx) const
{
...
std::optional<Direction> LandmarkSystem::get_direction_toward_landmark(TilePosition current_pos, std::size_t landmark_idx) const
{
...
std::int32_t LandmarkSystem::get_distance_to_landmark(TilePosition pos, std::size_t landmark_idx) const
{
...
std::int32_t LandmarkSystem::get_distance_between_landmarks(std::size_t from, std::size_t to) const
{
