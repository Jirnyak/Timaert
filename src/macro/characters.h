...
kLandmarkSheets = [] {
    ...
    // Деревня торгует как печёт — вдвое слабее города по рангу и с той же
    // скромной харизмой. Поэтому в городе крестьянин уступает в цене, а у
    // себя дома с заезжим караваном — уже нет: разница считается ОБЕИМИ
    // анкетами, и «дома дешевле» перестаёт быть свойством роли.
